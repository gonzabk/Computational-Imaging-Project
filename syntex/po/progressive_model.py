...
if __name__ == "__main__":
    ...
    ps.add("--save-epoch", type=int, default=SAVE_EPOCH)
    ...
    steps_per_epoch = args.get("steps_per_epoch", STEPS_PER_EPOCH) / max(n_gpu, 1)
    # lr starts decreasing at half of max epoch
    start_dec_epoch = START_DEC_EPOCH
    # stops when lr is 0.01 of its initial value
    end_epoch = max_epoch - int((max_epoch - start_dec_epoch) * STOP_LR_DECREASE)
